...
def cast_lightning(*args, **kwargs):
    ...
    # find closest entity that isn't the caster and isn't aetherial
    for entity in entities:
        if (entity.fighter and entity is not caster and not entity.aetherial
...
def cast_fireball(*args, **kwargs):
    ...
    if not caster.fov_map.fov[target_y][target_x]:
        ...
        results.append({"consumed": True, "message": msg})
        for entity in entities:
            if (entity.fighter and not entity.aetherial
